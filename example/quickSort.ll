...
{
main.entry:
  %".2" = getelementptr inbounds [18 x i8], [18 x i8]* @".str0", i32 0, i32 0
  %".3" = call i32 (i8*, ...) @"printf"(i8* %".2")
  %".4" = getelementptr inbounds [3 x i8], [3 x i8]* @".str1", i32 0, i32 0
  %".5" = call i32 (i8*, ...) @"scanf"(i8* %".4", i32* @"InputArray")
  %".6" = getelementptr inbounds [49 x i8], [49 x i8]* @".str2", i32 0, i32 0
...
@".str0" = constant [18 x i8] c"length of array: \00"
declare i32 @"scanf"(i8* %".1", ...)

@".str1" = constant [3 x i8] c"%d\00"
@".str2" = constant [49 x i8] c"elements of array (seprated by space or enter): \00"
